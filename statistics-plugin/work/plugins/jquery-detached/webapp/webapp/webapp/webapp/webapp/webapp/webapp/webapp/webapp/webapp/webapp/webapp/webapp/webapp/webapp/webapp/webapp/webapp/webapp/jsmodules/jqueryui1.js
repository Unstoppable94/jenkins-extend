...
ow();
	...
	_animate: function( toShow, toHide, data ) {
		...
		if ( !toHide.length ) {
owProps, duration, easing, complete );
		}
		if ( !toShow.length ) {
...
ow() which won't work on disconnected elements
...
ow(showAnim, $.datepicker._get(inst, "showOptions"), duration);
			} else {
...
ow().css( "visibility", "hidden" ).offset(),
